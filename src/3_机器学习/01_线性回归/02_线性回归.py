...
"""
@File    : 02_线性回归.py
@Time    : 2022/4/1 0001 17:26
@Author  : L
@Software: PyCharm
https://github.com/goodboyv/Sklearn_Mochine_leanring/blob/master/%E7%BA%BF%E6%80%A7%E5%9B%9E%E5%BD%92.py
"""
...
def linear():
    ...
    y_predict_sgd_inverse = std2.inverse_transform(y_predict_sgd.reshape(-1, 1))  # 反归一化
    print("sgd预测结果：", y_predict_sgd_inverse)

    # 均方误差
    error_sgd = mean_squared_error(y_test_ori, y_predict_sgd_inverse)
    print("sgd的均方误差：", error_sgd)
